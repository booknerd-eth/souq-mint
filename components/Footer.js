    ...
    <>
      <footer className={styles.footer}>
          <div className={styleAbsolute}>
              <a href="https://discord.gg/souq" target="_blank" rel="noopener noreferrer" className="m-2 p-2">
              ...
              <a href="http://twitter.com/Souqdotgg" target="_blank" rel="noopener noreferrer" className="m-2 p-2">
                <svg width="40" height="40" fill="none" xmlns="http://www.w3.org/2000/svg">
