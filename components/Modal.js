    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          <div className="m-3">
            <button type="button" className="rounded-full w-full text-xl hover:shadow-lg shadow-cyan-500/50 border-1 border-gray-50 hover:border-gray-300 flex items-center p-3">
